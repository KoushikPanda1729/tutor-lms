...
export function HeroSlider() {
  ...
  return (
    <section className="relative h-[90vh] min-h-[650px] flex items-center overflow-hidden">
      ...
      {/* Glassy overlay — light dark tint */}
      <div className="absolute inset-0 bg-black/35 backdrop-blur-[2px]" />

      {/* Gradient fade at bottom — subtle */}
      <div className="absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-black/20 to-transparent" />

      {/* Content */}
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center">
        <div className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm px-4 py-1.5 mb-7">
        ...
        <h1 className="text-6xl font-extrabold text-white leading-[1.1] tracking-tight mb-6 drop-shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
          <Link
            href="/register"
            className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-8 py-4 text-base font-bold text-white hover:bg-indigo-700 transition-colors shadow-lg"
          >
            Get Started Free <ArrowRight className="h-4 w-4" />
          </Link>
          <a
            href="#features"
            className="inline-flex items-center gap-2 rounded-xl border border-white/30 bg-white/10 backdrop-blur-sm px-8 py-4 text-base font-semibold text-white hover:bg-white/20 transition-colors"
          >
            See Features
          </a>
        </div>
