          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2.5 pl-1 rounded-xl hover:bg-slate-50 pr-2 py-1 transition-colors"
              >
              ...
              {profileOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 z-50 w-56 rounded-2xl bg-white shadow-xl border border-slate-100 overflow-hidden">
