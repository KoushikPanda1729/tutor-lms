      ...
      <div className="flex flex-1 pt-16">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-violet-700 flex-col justify-between p-12 text-white">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold">TutorLMS</span>
          </div>
          <div>
            <p className="text-4xl font-extrabold leading-tight mb-4">
              Start managing your coaching center today
            </p>
            <p className="text-indigo-200 text-lg mb-10">
              Join 40+ coaching centers already using TutorLMS to manage students, tests, attendance
              and more.
            </p>
            <div className="space-y-3">
              {[
                "Batch & Student Management",
                "Online Tests with Auto-grading",
                "Attendance Calendar",
                "Notes & Video Library",
              ].map((f) => (
          ...
          <p className="text-indigo-300 text-sm">Trusted by 40+ coaching centers across India</p>
        </div>
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <button
                ...
                className="w-full h-11 rounded-xl bg-indigo-600 text-white text-sm font-bold hover:bg-indigo-700 disabled:opacity-60 transition-colors flex items-center justify-center gap-2 mt-2"
              >
                {isSubmitting ? (
                  "Creating account..."
                ) : (
